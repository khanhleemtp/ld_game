...
import { LOGIN_FAIL, LOGIN_SUCCESS, LOGOUT_SUCCESS, REGISTER_FAIL, REGISTER_SUCCESS } from "../actions/types";
...
export const signIn = ({ username, password }) => async dispatch => {
  try {
    ...
    error && error.response.data && dispatch(returnErrors(error.response.data, error.response.status, LOGIN_FAIL));
  }
};
