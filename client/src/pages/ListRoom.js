...
export const ListRoom = () => {
  ...
  return (
    <div style={{ position: "relative", display: "flex", flexDirection: "column", alignItems: "center" }}>
      {isOpenPopup ? <Popup isOpenPopup={isOpenPopup} setIsOpenPopup={setIsOpenPopup} /> : null}
      ...
      >
        <div onClick={() => setIsOpenPopup(true)}>
          <Button bgColor="#13bafe" text="Phòng mới" iconSrc="/imgButton/room.svg" textColor="#001b4d" alt="btn" />
        </div>
      </div>
    </div>
  );
