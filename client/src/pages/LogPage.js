                                  ...
                                  <FormInputWrapper>
                                    ...
                                    <>
                                        <InputContainer
                                            label="Tên nhân vật:"
                                            placeholder=""
                                            setResource={registerResource.setName}
                                        />
                                        <InputContainer
                                            label="Tài khoản:"
                                            placeholder=""
                                            setResource={registerResource.setUsername}
                                        />
                                        <InputContainer
                                            label="Mật khẩu:"
                                            placeholder=""
                                            setResource={registerResource.setPassword}
                                        />
                                    </>
                                        )
                                    }
